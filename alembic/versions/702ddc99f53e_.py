...
Revision ID: 702ddc99f53e
Revises: a00d29f4877a
Create Date: 2024-02-27 14:21:49.892145
...
revision: str = "702ddc99f53e"
down_revision: Union[str, None] = "a00d29f4877a"
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('flight_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column("name", sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["flight_id"], ["flight.id"], name="ticket_flight_id_fkey"
        ),
